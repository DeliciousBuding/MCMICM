...
\noindent\textbf{\textit{This section addresses Task 3:}} We identify which contestant attributes (celebrity profession, professional partner, prior fame) predict survival, using Cox Proportional Hazards with stratified likelihoods for pro dancer effects.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/fig_forest_plot.jpg}
    \caption{\textbf{Survival Predictors: Forest Plot.} Hazard ratios (HR) from Cox proportional hazards model with 95\% confidence intervals. Values $<1$ indicate protective effects (longer survival). \emph{Key insight:} Judge scores and fan votes dominate celebrity profession---talent matters more than fame category.}
