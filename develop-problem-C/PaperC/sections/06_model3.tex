...
\begin{figure}[H]
    ...
    \caption{\textbf{Wrongful Elimination Reduction.} Comparison across mechanisms. The Weighted Percent system ($\alpha=0.6$) reduces definite-wrongful count from 40 to 3---a \textbf{92.5\% improvement}---while the Soft Floor mechanism actually \emph{increases} unfairness by protecting low-performing contestants.}
...
\begin{table}[H]
    \centering
    \caption{Definite-Wrongful Count vs.\ Judge Weight $\alpha$. \textbf{Bold}: optimal range.}
