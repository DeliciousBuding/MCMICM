...
For the Weighted Borda mechanism, we vary $\alpha$ (judge weight) from 0.3 to 0.8:
...
\begin{itemize}[itemsep=0.2em]
    ...
    \item \textbf{Borda wrongful rate:} 95\% CI is $[0.4\%, 2.6\%]$ (robust improvement over current system).
\end{itemize}
