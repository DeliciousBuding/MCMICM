...
Bones averaged only 22.4 judge points, substantially below Milo Manheim (27.3), Evanna Lynch (26.1), and Alexis Ren (26.5). Our LP inversion reveals an \emph{extremely wide} survival interval: $v_{\text{Bones}} \in [0.01, 0.91]$ at Week 7 (see Figure~\ref{fig:bobby_survival}). This means: even with fan support as low as 1\%, Bones could still survive under the percent system.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/bobby_bones_survival.png}
    \caption{Bobby Bones (S27) survival interval over time. The wide feasible region illustrates how the 50/50 percent system offers excessive protection to celebrities with strong fan bases, regardless of technical performance.}
    \label{fig:bobby_survival}
\end{figure}

\noindent\textbf{Key Insight:} This wide interval demonstrates that the current percent system offers \emph{excessive protection} to celebrities with dedicated fan bases, making technical skill almost irrelevant for survival. This finding motivates our Weighted Percent proposal (\secref{sec:model3}).
