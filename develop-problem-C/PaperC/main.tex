...
% =============================================================================
\definecolor{dwts-proposed}{HTML}{219EBC}   % 青蓝 - 新机制/推荐
\definecolor{dwts-baseline}{HTML}{02304A}   % 藏蓝 - 基准/原机制
\definecolor{dwts-warning}{HTML}{FA8600}    % 深橙 - 警示/不匹配
\definecolor{dwts-warning2}{HTML}{FF9E02}   % 亮橙 - 次级警示
\definecolor{dwts-fill}{HTML}{90C9E7}       % 浅蓝 - 填充/区间
\definecolor{dwts-accent}{HTML}{FEB705}     % 黄色 - 小标注
